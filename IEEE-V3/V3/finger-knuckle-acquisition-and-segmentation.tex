...
\begin{figure}[ht!]
    \centering
    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-a.jpg}%
    \label{}}
    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-b.jpg}%
    \label{}}
    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-c.jpg} %
    \label{}}


    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-d.jpg}%
    \label{}}
    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-e.jpg}%
    \label{}}
    \subfloat[]{\includegraphics[width=1.1in]{Figures/4-4-2-f.jpg}%
    \label{}}
