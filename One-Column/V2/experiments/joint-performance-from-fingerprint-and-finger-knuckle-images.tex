...
\begin{figure*}
    \centering
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/01.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/02.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/04.pdf}
    \label{}}

    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/05.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/06.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/07.pdf}
    \label{}}

    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/08.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/09.pdf}
    \label{}}
    \subfloat[]{\includegraphics[width=1.7in]{Figures/dynamic/10.pdf}
    \label{}}
